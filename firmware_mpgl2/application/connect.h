...
#define ANT_CHANNEL_PERIOD_LO_CONNECT   (u8)0x00              // Low byte of two-byte channel period 0x0001 - 0x7fff
#define ANT_CHANNEL_PERIOD_HI_CONNECT   (u8)0x20             // High byte of two-byte channel period 
